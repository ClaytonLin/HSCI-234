...
def draw():
    cube1.color = p5.color(46, 79, 157)
    target1.color = p5.color(255, 255, 255)
    p5.clear()
    p5.push()
    ...
    if (program_state == "play"):
        ...
        p5.text("You win!", p5.width / 2 - 150, p5.height / 2 - 125)
...
def is_palm_closed(detection):
    threshold = 50  # adjust this value to fine-tune the detection sensitivity
...
def check_win_condition():
    ...
    if distance((cube1.x, cube1.y), (target1.x, target1.y)) < threshold:
        program_state = "win"
